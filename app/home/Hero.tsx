    ...
    return (
        <>
            ...
            <div className="flex flex-col lg:flex-row pt-12 px-4 lg:pr-0 lg:pl-48 pb-[9.5rem] lg:pb-12 relative max-w-[120rem] mx-auto">
                ...
                <img src="/hero-image.png" alt="people carrying boxes" className="absolute right-0 bottom-0 w-full lg:h-full lg:max-w-[55%] object-contain object-bottom max-w-[27rem]"/>
            </div>
            <ReviewList />
        </>
    )
