...
export default function Hero () {
    return (
        <>
            <Menu page="long"/>
            <div className="flex flex-col lg:flex-row pt-12 px-4 lg:pr-48 lg:pl-48 pb-[8rem] lg:pb-12 relative max-w-[120rem] mx-auto">
                <div className="max-w-full lg:max-w-none">
                    <div className="pt-6 lg:pt-16 lg:pl-12 lg:pr-36 px-4 bg-accent rounded-3xl rounded-b-none lg:rounded-[3rem] lg:rounded-bl-none">
                        <h1 className="text-[2rem] lg:text-[4rem] font-russo text-white mb-6 lg:mb-8 leading-tight">Long Distance Moving <br className="hidden lg:block"/> Services <span className="text-black">Cross</span> the Country</h1>
                        <h2 className="text-base leading-none lg:text-[2rem] lg:leading-8 font-bold mb-4 lg:mb-12">Your trusted partner for long distance moves</h2>
                ...
                <img src="/long-hero.png" alt="cross country truck" className="absolute right-4 lg:right-48 bottom-0 w-full lg:h-full lg:max-w-[40%] xl:max-w-[50%] object-contain object-bottom max-w-[27rem]"/>
            </div>
            <ReviewList />
        </>
    )
