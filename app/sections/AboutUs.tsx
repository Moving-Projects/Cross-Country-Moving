    ...
    return (
        <div className="flex flex-col lg:flex-row-reverse mt-20 lg:mt-32 px-4 lg:max-w-[120rem] lg:mx-auto lg:px-48 lg:justify-between lg:gap-32">
            ...
            <div className="lg:w-[45%]">
                ...
                <button className="flex gap-1 lg:gap-2 py-3 lg:py-[1.125rem] px-6 lg:px-8 text-xs lg:text-[14px] lg:leading-6 font-bold bg-black text-white rounded-3xl group">FIND MORE <img src="/left-arrow.svg" alt="arrow right" className="size-4 lg:size-6 group-hover:translate-x-2 transition duration-300"/></button>
            </div>
        </div>
    )
}