    ...
    return (
        ...
        <div className="flex flex-col lg:flex-row gap-2 lg:gap-8 w-full lg:w-fit">
            <div className="flex flex-col gap-2 lg:gap-4 lg:flex-1">
                <input type="text" className="font-medium bg-transparent rounded-3xl border border-black py-2 lg:py-4 px-4 lg:px-8 placeholder:font-light placeholder:text-opacity-50 lg:h-[3.25rem] focus:outline-black" placeholder="Collection Address *" value={collection ? collection : undefined} onChange={(e) => {setCollection(e.currentTarget.value)}}/>
                <input type="text" className="font-medium bg-transparent rounded-3xl border border-black py-2 lg:py-4 px-4 lg:px-8 placeholder:font-light placeholder:text-opacity-50 lg:h-[3.25rem] focus:outline-black" placeholder="Moving Address *" value={moving ? moving : undefined} onChange={(e) => {setMoving(e.currentTarget.value)}}/>
                <SizeSelect />
            </div>
